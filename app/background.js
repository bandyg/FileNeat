...
electron__WEBPACK_IMPORTED_MODULE_3__.ipcMain.on('message', async (event, arg) => {
  event.reply('message', `${arg} World!`);
});
electron__WEBPACK_IMPORTED_MODULE_3__.ipcMain.on('check-file-exists', (event, filePath) => {
...
electron__WEBPACK_IMPORTED_MODULE_3__.ipcMain.on('open-folder-dialog', event => {
  electron__WEBPACK_IMPORTED_MODULE_3__.dialog.showOpenDialog({
    ...
    event.reply('folder-dialog-response', {
      error: err.message
